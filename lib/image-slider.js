...
exports['default'] = _react2['default'].createClass({
  ...
  updatePosition: function updatePosition(position) {
    var whole = position + this.props.visibleItems;
  ...
  isOpaque: function isOpaque(key) {
    var nextPosition = this.props.visibleItems + this.state.currentPosition;
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        images.map(function (item, key) {
          ...
          var imgWidth = 100 / _this.props.visibleItems;
      ...
      images.length > this.props.visibleItems ? _react2['default'].createElement(
        'div',
        null,
